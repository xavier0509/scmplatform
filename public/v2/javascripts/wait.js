		...
		if(this.status == 200) {
			...
			for(var i = 0; i < data.data.length; i++) {
				if(data.data[i].category == "main") {
					...
					console.log("main:" + kk);
					if(data.data[i].type == "string") {
						_rowMEPageConfigMain.innerHTML += "<div class='col-xs-6 mytextedit'><span name='" + data.data[kk].engName + "' title='" + data.data[kk].cnName + "'>" + data.data[kk].cnName + " :</span><input type='text' id='" + data.data[kk].engName + "' name='" + data.data[kk].type + "' oldvalue='" + data.data[kk].value + "' curvalue='0'></div>";
					} else if(data.data[i].type == "enum") {
						var _myAddselect = "<select id='" + data.data[kk].engName + "' name='" + data.data[kk].type + "' oldvalue='" + data.data[kk].value + "' curvalue='0'>";
						console.log("lxw " + data.data[kk].options.length);
						for(var k = 0; k < data.data[kk].options.length; k++) {
							if(data.data[kk].options[k] == data.data[kk].value) {
								_myAddselect += "<option value='" + data.data[kk].options[k] + "'selected>" + data.data[kk].options[k] + "</option>";
					...
					console.log("hardware:" + kk);
					if(data.data[i].type == "string") {
						_rowMEPageConfigHardware.innerHTML += "<div class='col-xs-6 mytextedit'><span name='" + data.data[kk].engName + "' title='" + data.data[kk].cnName + "'>" + data.data[kk].cnName + " :</span><input type='text' id='" + data.data[kk].engName + "' name='" + data.data[kk].type + "' oldvalue='" + data.data[kk].value + "' curvalue='0'></div>";
					} else if(data.data[i].type == "enum") {
						var _myAddselect = "<select id='" + data.data[kk].engName + "' name='" + data.data[kk].type + "' oldvalue='" + data.data[kk].value + "' curvalue='0'>";
						console.log("lxw " + data.data[kk].options.length);
						for(var k = 0; k < data.data[kk].options.length; k++) {
					...
					console.log("serverip:" + kk);
					if(data.data[i].type == "string") {
						_rowMEPageConfigServerip.innerHTML += "<div class='col-xs-6 mytextedit'><span name='" + data.data[kk].engName + "' title='" + data.data[kk].cnName + "'>" + data.data[kk].cnName + " :</span><input type='text' id='" + data.data[kk].engName + "' name='" + data.data[kk].type + "' oldvalue='" + data.data[kk].value + "' curvalue='0'></div>";
					} else if(data.data[i].type == "enum") {
						var _myAddselect = "<select id='" + data.data[kk].engName + "' name='" + data.data[kk].type + "' oldvalue='" + data.data[kk].value + "' curvalue='0'>";
						console.log("lxw " + data.data[kk].options.length);
						for(var k = 0; k < data.data[kk].options.length; k++) {
					...
					console.log("ad:" + kk);
					if(data.data[i].type == "string") {
						_rowMEPageConfigAd.innerHTML += "<div class='col-xs-6 mytextedit'><span name='" + data.data[kk].engName + "' title='" + data.data[kk].cnName + "'>" + data.data[kk].cnName + " :</span><input type='text' id='" + data.data[kk].engName + "' name='" + data.data[kk].type + "' oldvalue='" + data.data[kk].value + "' curvalue='0'></div>";
					} else if(data.data[i].type == "enum") {
						var _myAddselect = "<select id='" + data.data[kk].engName + "' name='" + data.data[kk].type + "' oldvalue='" + data.data[kk].value + "' curvalue='0'>";
						console.log("lxw " + data.data[kk].options.length);
						for(var k = 0; k < data.data[kk].options.length; k++) {
					...
					console.log("channel:" + kk);
					if(data.data[i].type == "string") {
						_rowMEPageConfigChannel.innerHTML += "<div class='col-xs-6 mytextedit'><span name='" + data.data[kk].engName + "' title='" + data.data[kk].cnName + "'>" + data.data[kk].cnName + " :</span><input type='text' id='" + data.data[kk].engName + "' name='" + data.data[kk].type + "' oldvalue='" + data.data[kk].value + "' curvalue='0'></div>";
					} else if(data.data[i].type == "enum") {
						var _myAddselect = "<select id='" + data.data[kk].engName + "' name='" + data.data[kk].type + "' oldvalue='" + data.data[kk].value + "' curvalue='0'>";
						console.log("lxw " + data.data[kk].options.length);
						for(var k = 0; k < data.data[kk].options.length; k++) {
					...
					console.log("localmedia:" + kk);
					if(data.data[i].type == "string") {
						_rowMEPageConfigLocalmedia.innerHTML += "<div class='col-xs-6 mytextedit'><span name='" + data.data[kk].engName + "' title='" + data.data[kk].cnName + "'>" + data.data[kk].cnName + " :</span><input type='text' id='" + data.data[kk].engName + "' name='" + data.data[kk].type + "' oldvalue='" + data.data[kk].value + "' curvalue='0'></div>";
					} else if(data.data[i].type == "enum") {
						var _myAddselect = "<select id='" + data.data[kk].engName + "' name='" + data.data[kk].type + "' oldvalue='" + data.data[kk].value + "' curvalue='0'>";
						console.log("lxw " + data.data[kk].options.length);
						for(var k = 0; k < data.data[kk].options.length; k++) {
					...
					console.log("browser:" + kk);
					if(data.data[i].type == "string") {
						_rowMEPageConfigBrowser.innerHTML += "<div class='col-xs-6 mytextedit'><span name='" + data.data[kk].engName + "' title='" + data.data[kk].cnName + "'>" + data.data[kk].cnName + " :</span><input type='text' id='" + data.data[kk].engName + "' name='" + data.data[kk].type + "' oldvalue='" + data.data[kk].value + "' curvalue='0'></div>";
					} else if(data.data[i].type == "enum") {
						var _myAddselect = "<select id='" + data.data[kk].engName + "' name='" + data.data[kk].type + "' oldvalue='" + data.data[kk].value + "' curvalue='0'>";
						console.log("lxw " + data.data[kk].options.length);
						for(var k = 0; k < data.data[kk].options.length; k++) {
					...
					console.log("other:" + kk);
					if(data.data[i].type == "string") {
						_rowMEPageConfigOther.innerHTML += "<div class='col-xs-6 mytextedit'><span name='" + data.data[kk].engName + "' title='" + data.data[kk].cnName + "'>" + data.data[kk].cnName + " :</span><input type='text' id='" + data.data[kk].engName + "' name='" + data.data[kk].type + "' oldvalue='" + data.data[kk].value + "' curvalue='0'></div>";
					} else if(data.data[i].type == "enum") {
						var _myAddselect = "<select id='" + data.data[kk].engName + "' name='" + data.data[kk].type + "' oldvalue='" + data.data[kk].value + "' curvalue='0'>";
						console.log("lxw " + data.data[kk].options.length);
						for(var k = 0; k < data.data[kk].options.length; k++) {
