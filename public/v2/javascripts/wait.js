	...
	if(this.readyState == 4) {
		if(this.status == 200) {
			...
			if(data.msg == "success") {
			    ...
			    sendHTTPRequest("/fybv2_api/sendmail", '{"data":{"desc":"'+maildata+'","from":"'+fromEmail+'","to":"liujinpeng@skyworth.com","subject":"软件配置平台通知-自动发送，请勿回复"}}', mailfun)
...
function sentMailForMoreFile(){
    ...
    maildata += "<br/>请前往《待审核文件》菜单进行审核处理<br/> -----<br/>进入配置平台请点击 <a href='http://172.20.132.225:3000/v2/scmplatform/index.html'>scmplatform</a>";
    console.log("maildata:"+maildata);
    sendHTTPRequest("/fybv2_api/sendmail", '{"data":{"desc":"'+maildata+'","from":"'+fromEmail+'","to":"liujinpeng@skyworth.com","subject":"软件配置平台通知-自动发送，请勿回复"}}', moreEditMailFun)			
}
...
function moreDeleteresult() {
	if(this.readyState == 4) {
        ...
        maildata += "<br/> 请前往《待审核文件》菜单进行审核处理<br>-----<br/>进入配置平台请点击 <a href='http://172.20.132.225:3000/v2/scmplatform/index.html'>scmplatform</a>";
        var nodeData = '{"data":{"desc":"'+maildata+'","from":"'+fromEmail+'","to":"liujinpeng@skyworth.com","subject":"软件配置平台通知-自动发送，请勿回复"}}';
